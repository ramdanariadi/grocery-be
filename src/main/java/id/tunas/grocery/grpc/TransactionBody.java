...
public  final class TransactionBody extends
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              products_ = new java.util.ArrayList<TransactionProduct>();
              mutable_bitField0_ |= 0x00000002;
            }
            products_.add(
                input.readMessage(TransactionProduct.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return TransactionOuterClass.internal_static_proto_TransactionBody_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            TransactionBody.class, TransactionBody.Builder.class);
  }
  ...
  private java.util.List<TransactionProduct> products_;
  /**
   * <code>repeated .proto.TransactionProduct products = 2;</code>
   */
  public java.util.List<TransactionProduct> getProductsList() {
    return products_;
  }
  /**
   * <code>repeated .proto.TransactionProduct products = 2;</code>
   */
  public java.util.List<? extends TransactionProductOrBuilder>
   ...
   * <code>repeated .proto.TransactionProduct products = 2;</code>
   */
  public TransactionProduct getProducts(int index) {
    return products_.get(index);
  }
  /**
   * <code>repeated .proto.TransactionProduct products = 2;</code>
   */
  public TransactionProductOrBuilder getProductsOrBuilder(
      int index) {
    return products_.get(index);
  }
  ...
  public static TransactionBody parseFrom(
  ...
  public static TransactionBody parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static TransactionBody parseFrom(
  ...
  public static TransactionBody parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static TransactionBody parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static TransactionBody parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public TransactionBody build() {
      TransactionBody result = buildPartial();
    ...
    public TransactionBody buildPartial() {
      TransactionBody result = new TransactionBody(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof TransactionBody) {
        return mergeFrom((TransactionBody)other);
      } else {
    ...
    public Builder mergeFrom(TransactionBody other) {
      if (other == TransactionBody.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      TransactionBody parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (TransactionBody) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureProductsIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        products_ = new java.util.ArrayList<TransactionProduct>(products_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            TransactionProduct, TransactionProduct.Builder, TransactionProductOrBuilder> productsBuilder_;
    ...
    public Builder setProducts(
        int index, TransactionProduct value) {
      if (productsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setProducts(
        int index, TransactionProduct.Builder builderForValue) {
      if (productsBuilder_ == null) {
        ensureProductsIsMutable();
     ...
     * <code>repeated .proto.TransactionProduct products = 2;</code>
     */
    public Builder addProducts(TransactionProduct value) {
      if (productsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addProducts(
        TransactionProduct.Builder builderForValue) {
      if (productsBuilder_ == null) {
        ensureProductsIsMutable();
    ...
    public Builder addAllProducts(
        java.lang.Iterable<? extends TransactionProduct> values) {
      if (productsBuilder_ == null) {
        ensureProductsIsMutable();
     ...
     * <code>repeated .proto.TransactionProduct products = 2;</code>
     */
    public TransactionProduct.Builder getProductsBuilder(
        int index) {
     ...
     * <code>repeated .proto.TransactionProduct products = 2;</code>
     */
    public TransactionProduct.Builder addProductsBuilder() {
      return getProductsFieldBuilder().addBuilder(
          TransactionProduct.getDefaultInstance());
    }
    /**
     * <code>repeated .proto.TransactionProduct products = 2;</code>
     */
    public TransactionProduct.Builder addProductsBuilder(
        int index) {
      return getProductsFieldBuilder().addBuilder(
          index, TransactionProduct.getDefaultInstance());
    }
    /**
     * <code>repeated .proto.TransactionProduct products = 2;</code>
     */
    public java.util.List<TransactionProduct.Builder>
         getProductsBuilderList() {
      return getProductsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
            TransactionProduct, TransactionProduct.Builder, TransactionProductOrBuilder>
        getProductsFieldBuilder() {
      if (productsBuilder_ == null) {
  ...
  static {
    DEFAULT_INSTANCE = new TransactionBody();
  }

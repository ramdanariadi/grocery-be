...
public  final class TransactionId extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TransactionOuterClass.internal_static_proto_TransactionId_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TransactionOuterClass.internal_static_proto_TransactionId_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            TransactionId.class, TransactionId.Builder.class);
  }
  ...
  public static TransactionId parseFrom(
  ...
  public static TransactionId parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static TransactionId parseFrom(
  ...
  public static TransactionId parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static TransactionId parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static TransactionId parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public TransactionId build() {
      TransactionId result = buildPartial();
    ...
    public TransactionId buildPartial() {
      TransactionId result = new TransactionId(this);
      result.id_ = id_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof TransactionId) {
        return mergeFrom((TransactionId)other);
      } else {
    ...
    public Builder mergeFrom(TransactionId other) {
      if (other == TransactionId.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      TransactionId parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (TransactionId) e.getUnfinishedMessage();
  ...
  static {
    DEFAULT_INSTANCE = new TransactionId();
  }

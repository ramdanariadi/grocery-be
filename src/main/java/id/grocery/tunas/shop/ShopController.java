...
public class ShopController {
    ...
    @PostMapping
    public ResponseEntity<Object> addStore(HttpServerRequest request, @RequestBody ShopDTO shop){
    ...
    @GetMapping
    public ResponseEntity<Object> getStore(HttpServerRequest request){
        JsonObject userCustomId = new JsonObject(request.getHeader("x-custom-id"));
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateStore(HttpServerRequest request, @PathVariable("id") UUID id, @RequestBody ShopDTO shop){
        JsonObject userCustomId = new JsonObject(request.getHeader("x-custom-id"));
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Object> deleteStore(HttpServerRequest request, @PathVariable("id") UUID id){
        JsonObject userCustomId = new JsonObject(request.getHeader("x-custom-id"));
